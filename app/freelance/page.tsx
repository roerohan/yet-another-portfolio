    ...
    <div className="min-h-screen bg-background text-white">
      ...
      <div className="fixed top-6 left-6 z-50">
        <Button variant="ghost" size="sm" asChild className="group">
          <Link
            href="/"
            className="flex items-center text-zinc-400 hover:text-cyan-500"
          >
        ...
        <div className="container relative z-10 mx-auto px-4 py-32 md:py-40">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-zinc-400">
              Silicon Farmer at Cloudflare. Ex-founding engineer at a Dyte, a YC
              startup. 5+ years of delivering high-quality solutions to clients
              worldwide on Upwork.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
              {achievements.map((achievement, index) => (
                ...
                >
                  <achievement.icon
                    className={`h-6 w-6 mb-2 ${achievement.color}`}
                  />
      ...
      <div className="container mx-auto px-4 py-16 space-y-24">
        ...
        <section id="services" className="scroll-mt-32">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              From concept to deployment, I provide comprehensive solutions
        ...
        <section id="github" className="scroll-mt-32">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              I believe in giving back to the community. Here's a glimpse of my
              open source work.
            </p>
          </div>
            ...
            <CardContent className="p-12 relative z-10">
              <div className="max-w-3xl mx-auto text-center space-y-6">
                ...
                <p className="text-lg text-zinc-400">
                  Whether you need a full-stack application, backend
                  infrastructure, security audit, or technical content, I'm here
