      ...
      <div>
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <a
              href="mailto:me@roerohan.com"
              className="text-zinc-300 hover:text-cyan-500"
            >
              me@roerohan.com
            </a>
          </div>
          <ul className="icons flex space-x-4">
            <li>
              <a href="https://x.com/roerohan" target="_blank" title="X">
                <i className="fab fa-twitter"></i>
              </a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/roerohan"
                target="_blank"
                title="LinkedIn"
              >
            ...
            <li>
              <a
                href="https://stackoverflow.com/users/11500806/"
                target="_blank"
                title="Stackoverflow"
              >
            ...
            <li>
              <a
                href="https://medium.com/@roerohan"
                target="_blank"
                title="Medium"
              >
            ...
            <li>
              <a
                href="mailto://roerohan@gmail.com"
                target="_blank"
                title="Mail"
              >
